...
public class SpecificEvent extends AppCompatActivity implements View.OnClickListener {
    ...
    private DatabaseReference eventRef, PartRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventRef = FirebaseDatabase.getInstance().getReference("events/" + key);
        PartRef = FirebaseDatabase.getInstance().getReference("Participants/" + key);

        data = new ValueEventListener() {
            @Override
                        ...
                        for (i = 0; i < imgPaths.size(); i++) {
                            ...
                            iv.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Bundle b = new Bundle();
                                    b.putStringArrayList("paths", imgPaths);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Message.ts(SpecificEvent.this, "Error occurred while loading!", getLayoutInflater(), findViewById(R.id.toastbg));
            }
        };
